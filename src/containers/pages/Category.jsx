          ...
          type === "" ?
            CategoryItems.map((data, index) => (
              ...
              <Card sx={{
                ...
                <CardActions>
                  <Button size="small" onClick={handleFeedback}>Nice</Button>
            ...
            CategoryItems.filter(item => item.category === type)
              .map((data, index) => (
...
const CategoryItems = [
  ...
  },
  {
    ...
    label: 'Shirts',
    category: 'Shop',
    details: 'A shirt is a piece of clothing worn on the upper part of your body with a collar, sleeves, and buttons down the front.',
  ...
  },
  {
    ...
    label: 'Grocery',
    category: 'Shop',
    details: 'Grocery shopping can be a messy affair, so make it easier by grabbing your favorite cereals, milk and much more at the supermarket.',
  ...
  },
  {
    ...
    label: 'Watermalon',
    category: 'Fruit',
    details: "This summer is so hot I think I need a bite of watermelon every minute.",
